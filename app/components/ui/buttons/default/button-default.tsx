...
function ButtonDefault({ content, Icon, iconStyles }: { content: string, Icon:IconType, iconStyles:string
 }) {
  return (
    <button className="w-full group relative grid overflow-hidden rounded-sm px-4 py-2 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200 group">
      <span>
