function DetailsPtbr() {
  return (
    <>
      ...
      <strong>Socket.IO</strong>, envio de email e SMS, e WhatsApp web. A
      maioria dessas tecnologias era
      <strong>nova para mim</strong>, tornando todo o projeto uma experiência
      refrescante e<strong>enriquecedora</strong>. Foi um verdadeiro{" "}
      <strong>divisor de águas</strong> na minha jornada. Durante{" "}
      <strong>cinco meses</strong>, dediquei-me a{" "}
      <strong>aprender novas tecnologias</strong> diariamente e implementá-las
      neste projeto. Eu carinhosamente o chamo de{" "}
      <strong>"meu pequeno Frankenstein"</strong> porque
      <strong>toda nova</strong> tecnologia que aprendo, eu testo nesta
      plataforma.
      <strong>Apesar do progresso</strong>, ainda faltam muitas funcionalidades
      a serem adicionadas, como um
      <strong>chatbot</strong>, <strong>chat em tempo real</strong>, integração
      com <strong>serviços postais</strong>, uma{" "}
...
function FeaturesPtbr() {
  return (
    <>
      ...
      <li>
        <strong className="uppercase">Carrinho de Compras</strong>: Processo de
        checkout simples e intuitivo.
      </li>
      <li>
      ...
      <li>
        <strong className="uppercase">Avaliações de Produtos</strong>: Avalie e
        escreva comentários sobre os produtos.
      </li>
      <li>
        <strong className="uppercase">Filtro Avançado</strong>: Encontre itens
        rapidamente com filtros robustos.
      </li>
      <li>
        <strong className="uppercase">Recuperação de Senha</strong>: Redefina a
        senha de forma segura via email.
      </li>
      <li>
        <strong className="uppercase">Verificação de Email e Telefone</strong>:
...
function DetailsEnus() {
  return (
    <>
      ...
      <strong>Node.js</strong>,<strong>TypeScript</strong>, <strong>SQL</strong>
      , <strong>payment gateways</strong>, <strong>OAuth</strong>, web scraping,
      voice recognition, webhooks,
      <strong> Socket.IO</strong>, email and sms sending, and web WhatsApp. Most
      of these technologies were new to me, making the entire project a
      refreshing and
      <strong> enriching</strong> experience. It was a real{" "}
      <strong>turning point</strong> in my journey. Over{" "}
      <strong>five months</strong>, I dedicated myself to{" "}
      <strong>learning new technologies</strong> daily and implementing them in
      this project. I affectionately call it my{" "}
      <strong>"little Frankenstein"</strong> because <strong>every new </strong>
      technology I learn, I test on this platform.{" "}
      <strong>Despite the progress</strong>, there are still many features to
      add, such as a<strong> chatbot</strong>, <strong>real-time chat</strong>,
      integration with <strong>postal services</strong>, a
...
function FeaturesEnus() {
  return (
    <>
      ...
      <li>
        <strong className="uppercase">Voice Search</strong>: Find products using
        voice commands.
      </li>
      <li>
      ...
      <li>
        <strong className="uppercase">Notifications</strong>: Real-time updates
        via dashboard, email, and SMS.
      </li>
      <li>
      ...
      <li>
        <strong className="uppercase">Product Reviews</strong>: Rate and review
        products.
      </li>
      <li>
        <strong className="uppercase">Advanced Filtering</strong>: Find items
        quickly with robust filters.
      </li>
      <li>
        <strong className="uppercase">Password Recovery</strong>: Reset password
        securely via email.
      </li>
      <li>
      ...
      <li>
        <strong className="uppercase">Coupon System</strong>: Enjoy discounts
        and promotions with dynamic coupons.
      </li>
    </>
  );
}
